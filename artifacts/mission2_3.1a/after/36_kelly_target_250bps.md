...
- **Rationale:**
  ...
  - Cap-rate spread is thin at 0.85% (< 2.50%).
  - Projected IRR (10y) is 12.29% (≥ 12.00%).
  - Year-1 cash flow is negative at $-2,946.
- **Suggested Levers:**
  - Negotiate lower price to improve cap-rate spread to ≥ 250 bps.
...
| Inputs file | artifacts/mission2_3.1a/configs/36_kelly_target_250bps.json | `--config` |
